...
// #include "WConstants.h"  Deprecated. Arduino.h instead
#include "Arduino.h"
...
#define CLKFUDGE 5      // fudge factor for clock interrupt overhead
	...
	#define TCNT TCNT2
#else
	#define CLKMAX 65536      // max value for clock (timer 1)
	#define TCNT TCNT1
#endif
...
#define INIT_TIMER_COUNT (CLKMAX - USECPERTICK*CLKSPERUSEC + CLKFUDGE)
#define RESET_TIMER TCNT = INIT_TIMER_COUNT
